...
//       // Setup a counter to track getWord calls and return specific values
//       let getWordCallCount = 0;
//       memory.getWord.mockImplementation(() => {
//         getWordCallCount++;
//         switch (getWordCallCount) {
//           case 1:
//             return 3; // Available slots
//           case 2:
//             return 5; // getInitialCapacity -> max nonzero
//           case 3:
//             return 100; // Value to pull
//           default:
//             return 0;
//         }
//       });
...
//       // Setup for getWord sequence
//       let getWordCallCount = 0;
//       memory.getWord.mockImplementation(() => {
//         getWordCallCount++;
//         switch (getWordCallCount) {
//           case 1:
//             return 5; // Available slots (max)
//           case 2:
//             return 5; // Total capacity is same as available -> empty
//           default:
//             return 0;
//         }
//       });
...
//       // First getWord call for available slots
//       memory.getWord.mockReturnValueOnce(3);

//       // Mock getInitialCapacity value request
//       memory.getWord.mockReturnValueOnce(5);

//       // Mock error on third getWord call (value retrieval)
//       memory.getWord.mockImplementationOnce(() => {
//         throw new Error('Mock error');
//       });
...
//             return 3; // Available slots
//           case 2:
//             return 5; // Total capacity (so 2 items used)
//           default:
//             return 0;
//         }
//       });
...
//   describe('getInitialCapacity (tested indirectly)', () => {
//     it('should correctly calculate capacity based on non-zero slots', () => {
//       const stackAddr = 0x1000;

//       // Setup for mocking the pullStack method
//       const originalPullStack = userStackManager.pullStack;
//       userStackManager.pullStack = vi.fn().mockReturnValue(101);

//       const result = userStackManager.pullStack(stackAddr);

//       // Reset the mocked function
//       userStackManager.pullStack = originalPullStack;
